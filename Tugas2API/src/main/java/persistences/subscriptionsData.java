...
// DateTimeFormatter for parsing and formatting date-time strings
    ...
    public String addNewSubscription(Subscriptions subscription) throws SQLException {
        ...
        try {
            ...
            statement.setString(5, subscription.getActivated_at().format(formatter));
            statement.setString(6, subscription.getCurrent_term_start().format(formatter));
            statement.setString(7, subscription.getCurrent_term_end().format(formatter));
    ...
    public String updateSubscription(Subscriptions subscription, int idSubscription) throws SQLException {
        ...
        try {
            ...
            statement.setString(4, subscription.getActivated_at().format(formatter));
            statement.setString(5, subscription.getCurrent_term_start().format(formatter));
            statement.setString(6, subscription.getCurrent_term_end().format(formatter));
